...
<body>
	...
	?>
	<main>
		<form id="testMain" action='dataScripts/overall_testing_VeryHard.php'  method='post' >
								<?php echo $_SESSION['counter']+1; ?>/25
								<h2><?php echo $_SESSION['question'][$_SESSION['counter']]; ?> <h2>
								<input name="Ans3" type="submit"  value="a"> <?php echo $_SESSION['ansA'][$_SESSION['counter']]; ?>
								</br>
								<input name="Ans3" type="submit"  value="b"> <?php echo $_SESSION['ansB'][$_SESSION['counter']]; ?>
								</br>
								<input name="Ans3" type="submit"  value="c"> <?php echo $_SESSION['ansC'][$_SESSION['counter']]; ?>
								</br>
								<input name="Ans3" type="submit"  value="d"> <?php echo $_SESSION['ansD'][$_SESSION['counter']]; ?>
								</br>
			</form>
	</main>
</body>
